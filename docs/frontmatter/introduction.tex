...
\subsection*{Designing an Extensible Library} % (fold)
...
\end{enumerate}
% subsection Decorating iterables (end)
...
\subsection*{Ensure the Usefulness of the Library} % (fold)
\label{sub:User tests}
% subsection User tests (end)
