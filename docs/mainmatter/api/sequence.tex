...
This section overviews which operations exist to create and modify Sequences
and how to import this library into your own project. An in-depth view of how a
Sequence works internally, give section~\ref{sec:Sequence: A Series of Values}.
