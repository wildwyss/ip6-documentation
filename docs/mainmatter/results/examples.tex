...
The following section covers easy-to-understand and more sophisticated
examples. Consider consulting the listed sources to understand the applications
thoroughly.
...
Goodness~\cite{frege_goodness} includes a detailed explanation of the game.
...
be implemented with the Sequence library. For a deeper understanding of the
...
matching, the functions |opponent| and |stone| uses a workaround via an object.
