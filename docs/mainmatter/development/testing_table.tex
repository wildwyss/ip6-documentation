...
shows the instruments already available from the Kolibri Web UI Toolkit and
...
and exciting details are covered in depth. The end of the chapter discusses some
...
\begin{enumerate}
  ...
  \item{A function |addToTestingTable| includes all tests from the testing
