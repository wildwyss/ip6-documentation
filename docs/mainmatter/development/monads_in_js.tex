...
to |maybeX|. This creates a new function which is again in the |Maybe|
...
limitations, JSDoc can model a monad well.
...
types \cite{baeldung_higher-kinded_2020}, which would type definitions as defined by
