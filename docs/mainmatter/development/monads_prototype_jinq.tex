...
\subsubsection{Which operations are suitable for JavaScript?} % (fold)
\label{Which operations are suitable for JavaScript?}

% subsubsection Which operations are suitable for JavaScript? (end)
\subsubsection{Which operations are less suitable for JavaScript?} % (fold)
\label{sec:Which operations are less suitable for JavaScript?}

% subsubsection Which operations are less suitable for JavaScript? (end)
