...
\label{sec:The SequenceType}

The SequenceType|SequenceType| represents a sequence and the monadic functions defined on it. 
...
\label{sec:SequenceType vs. Iterable}
SequenceType vs. IterableSo the |SequenceType| describes object which are iterable and having their
prototype set to |SequencePrototype|. An object of type |Iterable| is just
iterable. This means, every operator receives an object of type |Iterable| as
